...
const (
	...
	CreateSandboxPhase_CREATE_SANDBOX_PHASE_RUN_POST_DEPENDENCIES_HOOK     CreateSandboxPhase = 11
	CreateSandboxPhase_CREATE_SANDBOX_PHASE_READY                          CreateSandboxPhase = 12
)
...
var (
	CreateSandboxPhase_name = map[int32]string{
		...
		11: "CREATE_SANDBOX_PHASE_RUN_POST_DEPENDENCIES_HOOK",
		12: "CREATE_SANDBOX_PHASE_READY",
	}
	CreateSandboxPhase_value = map[string]int32{
		...
		"CREATE_SANDBOX_PHASE_RUN_POST_DEPENDENCIES_HOOK":     11,
		"CREATE_SANDBOX_PHASE_READY":                          12,
	}
)
...
type PolicyHooks struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	PostDependencies []string               `protobuf:"bytes,1,rep,name=post_dependencies,json=postDependencies,proto3" json:"post_dependencies,omitempty"`
	PreRun           []string               `protobuf:"bytes,2,rep,name=pre_run,json=preRun,proto3" json:"pre_run,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *PolicyHooks) Reset() {
	*x = PolicyHooks{}
...
func (x *PolicyHooks) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PolicyHooks) ProtoMessage() {}

func (x *PolicyHooks) ProtoReflect() protoreflect.Message {
	mi := &file_proto_cleanroom_v1_control_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PolicyHooks.ProtoReflect.Descriptor instead.
func (*PolicyHooks) Descriptor() ([]byte, []int) {
	return file_proto_cleanroom_v1_control_proto_rawDescGZIP(), []int{7}
}

func (x *PolicyHooks) GetPostDependencies() []string {
	if x != nil {
		return x.PostDependencies
	}
	return nil
}

func (x *PolicyHooks) GetPreRun() []string {
	if x != nil {
		return x.PreRun
	}
	return nil
...
type Policy struct {
	...
	Hooks          *PolicyHooks           `protobuf:"bytes,10,opt,name=hooks,proto3" json:"hooks,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Policy) GetHooks() *PolicyHooks {
	if x != nil {
		return x.Hooks
	}
	return nil
...
const file_proto_cleanroom_v1_control_proto_rawDesc = "" +
	...
	"\x03key\x18\x02 \x01(\v2!.cleanroom.v1.PolicyDependencyKeyR\x03key\"S\n" +
	"\vPolicyHooks\x12+\n" +
	"\x11post_dependencies\x18\x01 \x03(\tR\x10postDependencies\x12\x17\n" +
	"\apre_run\x18\x02 \x03(\tR\x06preRun\"\x85\x03\n" +
	"\x06Policy\x12\x18\n" +
	...
	"\x05hooks\x18\n" +
	" \x01(\v2\x19.cleanroom.v1.PolicyHooksR\x05hooks\"R\n" +
	...
	"\x123\n" +
	"/CREATE_SANDBOX_PHASE_RUN_POST_DEPENDENCIES_HOOK\x10\v\x12\x1e\n" +
	"\x1aCREATE_SANDBOX_PHASE_READY\x10\f*\xea\x01\n" +
...
var file_proto_cleanroom_v1_control_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_proto_cleanroom_v1_control_proto_goTypes = []any{
	...
	(*PolicyHooks)(nil),                 // 11: cleanroom.v1.PolicyHooks
	...
	(*CreateSandboxRequest)(nil),        // 15: cleanroom.v1.CreateSandboxRequest
	(*CreateSandboxResponse)(nil),       // 16: cleanroom.v1.CreateSandboxResponse
	(*CreateSandboxEvent)(nil),          // 17: cleanroom.v1.CreateSandboxEvent
	(*GetSandboxRequest)(nil),           // 18: cleanroom.v1.GetSandboxRequest
	(*GetSandboxResponse)(nil),          // 19: cleanroom.v1.GetSandboxResponse
	(*ListSandboxesRequest)(nil),        // 20: cleanroom.v1.ListSandboxesRequest
	(*ListSandboxesResponse)(nil),       // 21: cleanroom.v1.ListSandboxesResponse
	(*DownloadSandboxFileRequest)(nil),  // 22: cleanroom.v1.DownloadSandboxFileRequest
	(*DownloadSandboxFileResponse)(nil), // 23: cleanroom.v1.DownloadSandboxFileResponse
	(*TerminateSandboxRequest)(nil),     // 24: cleanroom.v1.TerminateSandboxRequest
	(*TerminateSandboxResponse)(nil),    // 25: cleanroom.v1.TerminateSandboxResponse
	(*StreamSandboxEventsRequest)(nil),  // 26: cleanroom.v1.StreamSandboxEventsRequest
	(*SandboxEvent)(nil),                // 27: cleanroom.v1.SandboxEvent
	(*CreateSnapshotRequest)(nil),       // 28: cleanroom.v1.CreateSnapshotRequest
	(*CreateSnapshotResponse)(nil),      // 29: cleanroom.v1.CreateSnapshotResponse
	(*GetSnapshotRequest)(nil),          // 30: cleanroom.v1.GetSnapshotRequest
	(*GetSnapshotResponse)(nil),         // 31: cleanroom.v1.GetSnapshotResponse
	(*ListSnapshotsRequest)(nil),        // 32: cleanroom.v1.ListSnapshotsRequest
	(*ListSnapshotsResponse)(nil),       // 33: cleanroom.v1.ListSnapshotsResponse
	(*DeleteSnapshotRequest)(nil),       // 34: cleanroom.v1.DeleteSnapshotRequest
	(*DeleteSnapshotResponse)(nil),      // 35: cleanroom.v1.DeleteSnapshotResponse
	(*Execution)(nil),                   // 36: cleanroom.v1.Execution
	(*ExecutionOptions)(nil),            // 37: cleanroom.v1.ExecutionOptions
	(*CreateExecutionRequest)(nil),      // 38: cleanroom.v1.CreateExecutionRequest
	(*CreateExecutionResponse)(nil),     // 39: cleanroom.v1.CreateExecutionResponse
	(*AttachExecutionRequest)(nil),      // 40: cleanroom.v1.AttachExecutionRequest
	(*AttachExecutionResponse)(nil),     // 41: cleanroom.v1.AttachExecutionResponse
	(*GetExecutionRequest)(nil),         // 42: cleanroom.v1.GetExecutionRequest
	(*GetExecutionResponse)(nil),        // 43: cleanroom.v1.GetExecutionResponse
	(*InspectExecutionRequest)(nil),     // 44: cleanroom.v1.InspectExecutionRequest
	(*InspectExecutionResponse)(nil),    // 45: cleanroom.v1.InspectExecutionResponse
	(*CancelExecutionRequest)(nil),      // 46: cleanroom.v1.CancelExecutionRequest
	(*CancelExecutionResponse)(nil),     // 47: cleanroom.v1.CancelExecutionResponse
	(*WriteExecutionStdinRequest)(nil),  // 48: cleanroom.v1.WriteExecutionStdinRequest
	(*WriteExecutionStdinResponse)(nil), // 49: cleanroom.v1.WriteExecutionStdinResponse
	(*CloseExecutionStdinRequest)(nil),  // 50: cleanroom.v1.CloseExecutionStdinRequest
	(*CloseExecutionStdinResponse)(nil), // 51: cleanroom.v1.CloseExecutionStdinResponse
	(*StreamExecutionRequest)(nil),      // 52: cleanroom.v1.StreamExecutionRequest
	(*ExecutionExit)(nil),               // 53: cleanroom.v1.ExecutionExit
	(*ExecutionStreamEvent)(nil),        // 54: cleanroom.v1.ExecutionStreamEvent
...
var file_proto_cleanroom_v1_control_proto_depIdxs = []int32{
	...
	55, // 1: cleanroom.v1.Sandbox.created_at:type_name -> google.protobuf.Timestamp
	55, // 2: cleanroom.v1.Sandbox.updated_at:type_name -> google.protobuf.Timestamp
	55, // 3: cleanroom.v1.Snapshot.created_at:type_name -> google.protobuf.Timestamp
	...
	11, // 10: cleanroom.v1.Policy.hooks:type_name -> cleanroom.v1.PolicyHooks
	13, // 11: cleanroom.v1.CreateSandboxRequest.options:type_name -> cleanroom.v1.SandboxOptions
	12, // 12: cleanroom.v1.CreateSandboxRequest.policy:type_name -> cleanroom.v1.Policy
	14, // 13: cleanroom.v1.CreateSandboxRequest.repository_checkout:type_name -> cleanroom.v1.RepositoryCheckout
	4,  // 14: cleanroom.v1.CreateSandboxResponse.sandbox:type_name -> cleanroom.v1.Sandbox
	1,  // 15: cleanroom.v1.CreateSandboxEvent.phase:type_name -> cleanroom.v1.CreateSandboxPhase
	16, // 16: cleanroom.v1.CreateSandboxEvent.response:type_name -> cleanroom.v1.CreateSandboxResponse
	55, // 17: cleanroom.v1.CreateSandboxEvent.occurred_at:type_name -> google.protobuf.Timestamp
	4,  // 18: cleanroom.v1.GetSandboxResponse.sandbox:type_name -> cleanroom.v1.Sandbox
	4,  // 19: cleanroom.v1.ListSandboxesResponse.sandboxes:type_name -> cleanroom.v1.Sandbox
	0,  // 20: cleanroom.v1.SandboxEvent.status:type_name -> cleanroom.v1.SandboxStatus
	55, // 21: cleanroom.v1.SandboxEvent.occurred_at:type_name -> google.protobuf.Timestamp
	5,  // 22: cleanroom.v1.CreateSnapshotResponse.snapshot:type_name -> cleanroom.v1.Snapshot
	5,  // 23: cleanroom.v1.GetSnapshotResponse.snapshot:type_name -> cleanroom.v1.Snapshot
	5,  // 24: cleanroom.v1.ListSnapshotsResponse.snapshots:type_name -> cleanroom.v1.Snapshot
	2,  // 25: cleanroom.v1.Execution.status:type_name -> cleanroom.v1.ExecutionStatus
	55, // 26: cleanroom.v1.Execution.started_at:type_name -> google.protobuf.Timestamp
	55, // 27: cleanroom.v1.Execution.finished_at:type_name -> google.protobuf.Timestamp
	3,  // 28: cleanroom.v1.Execution.kind:type_name -> cleanroom.v1.ExecutionKind
	37, // 29: cleanroom.v1.CreateExecutionRequest.options:type_name -> cleanroom.v1.ExecutionOptions
	3,  // 30: cleanroom.v1.CreateExecutionRequest.kind:type_name -> cleanroom.v1.ExecutionKind
	14, // 31: cleanroom.v1.CreateExecutionRequest.repository_checkout:type_name -> cleanroom.v1.RepositoryCheckout
	36, // 32: cleanroom.v1.CreateExecutionResponse.execution:type_name -> cleanroom.v1.Execution
	55, // 33: cleanroom.v1.AttachExecutionResponse.expires_at:type_name -> google.protobuf.Timestamp
	36, // 34: cleanroom.v1.GetExecutionResponse.execution:type_name -> cleanroom.v1.Execution
	36, // 35: cleanroom.v1.InspectExecutionResponse.execution:type_name -> cleanroom.v1.Execution
	56, // 36: cleanroom.v1.InspectExecutionResponse.observability:type_name -> google.protobuf.Struct
	2,  // 37: cleanroom.v1.CancelExecutionResponse.status:type_name -> cleanroom.v1.ExecutionStatus
	2,  // 38: cleanroom.v1.ExecutionExit.status:type_name -> cleanroom.v1.ExecutionStatus
	2,  // 39: cleanroom.v1.ExecutionStreamEvent.status:type_name -> cleanroom.v1.ExecutionStatus
	53, // 40: cleanroom.v1.ExecutionStreamEvent.exit:type_name -> cleanroom.v1.ExecutionExit
	55, // 41: cleanroom.v1.ExecutionStreamEvent.occurred_at:type_name -> google.protobuf.Timestamp
	15, // 42: cleanroom.v1.SandboxService.CreateSandbox:input_type -> cleanroom.v1.CreateSandboxRequest
	15, // 43: cleanroom.v1.SandboxService.CreateSandboxStream:input_type -> cleanroom.v1.CreateSandboxRequest
	18, // 44: cleanroom.v1.SandboxService.GetSandbox:input_type -> cleanroom.v1.GetSandboxRequest
	20, // 45: cleanroom.v1.SandboxService.ListSandboxes:input_type -> cleanroom.v1.ListSandboxesRequest
	22, // 46: cleanroom.v1.SandboxService.DownloadSandboxFile:input_type -> cleanroom.v1.DownloadSandboxFileRequest
	24, // 47: cleanroom.v1.SandboxService.TerminateSandbox:input_type -> cleanroom.v1.TerminateSandboxRequest
	26, // 48: cleanroom.v1.SandboxService.StreamSandboxEvents:input_type -> cleanroom.v1.StreamSandboxEventsRequest
	28, // 49: cleanroom.v1.SnapshotService.CreateSnapshot:input_type -> cleanroom.v1.CreateSnapshotRequest
	30, // 50: cleanroom.v1.SnapshotService.GetSnapshot:input_type -> cleanroom.v1.GetSnapshotRequest
	32, // 51: cleanroom.v1.SnapshotService.ListSnapshots:input_type -> cleanroom.v1.ListSnapshotsRequest
	34, // 52: cleanroom.v1.SnapshotService.DeleteSnapshot:input_type -> cleanroom.v1.DeleteSnapshotRequest
	38, // 53: cleanroom.v1.ExecutionService.CreateExecution:input_type -> cleanroom.v1.CreateExecutionRequest
	40, // 54: cleanroom.v1.ExecutionService.AttachExecution:input_type -> cleanroom.v1.AttachExecutionRequest
	42, // 55: cleanroom.v1.ExecutionService.GetExecution:input_type -> cleanroom.v1.GetExecutionRequest
	44, // 56: cleanroom.v1.ExecutionService.InspectExecution:input_type -> cleanroom.v1.InspectExecutionRequest
	46, // 57: cleanroom.v1.ExecutionService.CancelExecution:input_type -> cleanroom.v1.CancelExecutionRequest
	48, // 58: cleanroom.v1.ExecutionService.WriteExecutionStdin:input_type -> cleanroom.v1.WriteExecutionStdinRequest
	50, // 59: cleanroom.v1.ExecutionService.CloseExecutionStdin:input_type -> cleanroom.v1.CloseExecutionStdinRequest
	52, // 60: cleanroom.v1.ExecutionService.StreamExecution:input_type -> cleanroom.v1.StreamExecutionRequest
	16, // 61: cleanroom.v1.SandboxService.CreateSandbox:output_type -> cleanroom.v1.CreateSandboxResponse
	17, // 62: cleanroom.v1.SandboxService.CreateSandboxStream:output_type -> cleanroom.v1.CreateSandboxEvent
	19, // 63: cleanroom.v1.SandboxService.GetSandbox:output_type -> cleanroom.v1.GetSandboxResponse
	21, // 64: cleanroom.v1.SandboxService.ListSandboxes:output_type -> cleanroom.v1.ListSandboxesResponse
	23, // 65: cleanroom.v1.SandboxService.DownloadSandboxFile:output_type -> cleanroom.v1.DownloadSandboxFileResponse
	25, // 66: cleanroom.v1.SandboxService.TerminateSandbox:output_type -> cleanroom.v1.TerminateSandboxResponse
	27, // 67: cleanroom.v1.SandboxService.StreamSandboxEvents:output_type -> cleanroom.v1.SandboxEvent
	29, // 68: cleanroom.v1.SnapshotService.CreateSnapshot:output_type -> cleanroom.v1.CreateSnapshotResponse
	31, // 69: cleanroom.v1.SnapshotService.GetSnapshot:output_type -> cleanroom.v1.GetSnapshotResponse
	33, // 70: cleanroom.v1.SnapshotService.ListSnapshots:output_type -> cleanroom.v1.ListSnapshotsResponse
	35, // 71: cleanroom.v1.SnapshotService.DeleteSnapshot:output_type -> cleanroom.v1.DeleteSnapshotResponse
	39, // 72: cleanroom.v1.ExecutionService.CreateExecution:output_type -> cleanroom.v1.CreateExecutionResponse
	41, // 73: cleanroom.v1.ExecutionService.AttachExecution:output_type -> cleanroom.v1.AttachExecutionResponse
	43, // 74: cleanroom.v1.ExecutionService.GetExecution:output_type -> cleanroom.v1.GetExecutionResponse
	45, // 75: cleanroom.v1.ExecutionService.InspectExecution:output_type -> cleanroom.v1.InspectExecutionResponse
	47, // 76: cleanroom.v1.ExecutionService.CancelExecution:output_type -> cleanroom.v1.CancelExecutionResponse
	49, // 77: cleanroom.v1.ExecutionService.WriteExecutionStdin:output_type -> cleanroom.v1.WriteExecutionStdinResponse
	51, // 78: cleanroom.v1.ExecutionService.CloseExecutionStdin:output_type -> cleanroom.v1.CloseExecutionStdinResponse
	54, // 79: cleanroom.v1.ExecutionService.StreamExecution:output_type -> cleanroom.v1.ExecutionStreamEvent
...
func file_proto_cleanroom_v1_control_proto_init() {
	...
	file_proto_cleanroom_v1_control_proto_msgTypes[11].OneofWrappers = []any{
	...
	file_proto_cleanroom_v1_control_proto_msgTypes[50].OneofWrappers = []any{
