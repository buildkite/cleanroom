...
const (
	...
	MetricSandboxSuspendDurationSeconds = "cleanroom_sandbox_suspend_duration_seconds"
	MetricSandboxWakeDurationSeconds    = "cleanroom_sandbox_wake_duration_seconds"
	...
	AttrCacheBlock             = "cleanroom.cache.block"
	AttrCacheKey               = "cleanroom.cache.key"
	AttrCacheOutputDirs        = "cleanroom.cache.output.dirs"
	AttrCacheOutputFiles       = "cleanroom.cache.output.files"
